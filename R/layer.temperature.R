...
#'@description This function calculates the average temperature of a layer of 
#'water between two depths.
#'@param top Numeric value of the depth (m) of the top of the layer from the water surface
#'@param bottom Numeric value of the depth (m) of the bottom of the layer from the water surface
#'@param wtr Numeric vector of water temperature in degrees C
#'@param depths Numeric vector of depths (m) corresponding to water temperature vector
#'@param bthA Numeric vector of water body cross sectional area (m2) corresponding to bthD depths
#'@param bthD Numeric vector of water body bathymetric depths (m) corresponding to areal bthA values
#'@return Numeric value of average water temperature
#'@author Jordan S. Read
#'@seealso \link{layer.density}
#'@examples 
#'# Supply input data
#'top     <- 2
#'bottom  <- 6
